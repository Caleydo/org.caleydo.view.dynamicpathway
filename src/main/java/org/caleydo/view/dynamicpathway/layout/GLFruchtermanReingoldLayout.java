...
public class GLFruchtermanReingoldLayout implements IGLLayout2 {
	 ...
	 */
	public GLFruchtermanReingoldLayout() {
	 ...
	 */
	public GLFruchtermanReingoldLayout(double repulsionMultiplier, double attractionMultiplier) {
		this.maxIterations = MAX_ITERATIONS;
		this.temperatureAndCooldownSetByUser = false;
	 ...
	 * @param attractionMultiplier {@link #attractionMultiplier}
	 */
	public GLFruchtermanReingoldLayout(int maxIterations, double temperature, double cooldown, double repulsionMultiplier, double attractionMultiplier) {
		this.maxIterations = maxIterations;
		this.temperature = temperature;
		this.cooldown = cooldown;		
		this.temperatureAndCooldownSetByUser = true;		
